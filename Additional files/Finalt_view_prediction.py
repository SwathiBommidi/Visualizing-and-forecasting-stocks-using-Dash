...
# other supporting modules form the keras
...
prediction_model.add(LSTM(200, activation='relu', input_shape=(input_length, feature_count)))
# dropout 0.15
prediction_model.add(Dropout(0.15))
# dense model 1
prediction_model.add(Dense(1))
# compile the model
prediction_model.compile(optimizer='adam', loss='mse')
# number of epochs 90
prediction_model.fit_generator(generator, epochs=9)
...
for i in range(input_length):
    prediction_list.append(prediction_model.predict(batch)[0])
